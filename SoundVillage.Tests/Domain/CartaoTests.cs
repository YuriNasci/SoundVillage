...
namespace SoundVillage.Tests.Domain
{
    public class CartaoTests
    {
        ...
        public void DeveCriarTransacaoComSucesso()
        {
            ...
            var merchant = new SoundVillage.Domain.Transacao.ValueObject.Merchant()
            {
                Nome = "Dummy"
            };
        ...
        public void NaoDeveCriarTransacaoComCartaoValorDuplicado()
        {
            ...
            cartao.Transacoes.Add(new Transacao()
            {
        ...
        public void NaoDeveCriarTransacaoComCartaoAltoFrequencia()
        {
            ...
            cartao.Transacoes.Add(new Transacao()
            {
                DataTransacao = DateTime.Now.AddMinutes(-1),
                Id = Guid.NewGuid(),
                Merchant = new Merchant()
                {
                    Nome = "Dummy"
            ...
            cartao.Transacoes.Add(new SoundVillage.Domain.Transacao.Agreggates.Transacao()
            {
                DataTransacao = DateTime.Now.AddMinutes(-0.5),
                Id = Guid.NewGuid(),
                Merchant = new SoundVillage.Domain.Transacao.ValueObject.Merchant()
                {
                    Nome = "Dummy"
                },
                Valor = 19M,
