...
namespace SoundVillage.Repository.Migrations
{
    ...
    [Migration("20240828003449_AddSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoundVillage.Domain.Streaming.Agreggates.MusicaFavorita", b =>
                {
                    b.Property<Guid>("UsuarioId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoundVillage.Domain.Streaming.Agreggates.Plano", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0f2108e3-6968-4d5b-ae9a-87667e7bc60d"),
                            ContaBancariaId = new Guid("f825761f-2621-46cc-a24b-21852a3e918d"),
                        ...
                        new
                        {
                            Id = new Guid("4bf62345-0101-4dd0-9297-4eb541aa06cf"),
                            ContaBancariaId = new Guid("f825761f-2621-46cc-a24b-21852a3e918d"),
            ...
            modelBuilder.Entity("SoundVillage.Domain.Transacao.Aggregates.ContaBancaria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f825761f-2621-46cc-a24b-21852a3e918d"),
                            Cpf = "11122233344",
                            Digito = "9",
                    ...
                    b.OwnsOne("SoundVillage.Domain.Core.ValueObjects.Monetario", "Valor", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    PlanoId = new Guid("0f2108e3-6968-4d5b-ae9a-87667e7bc60d"),
                                    Valor = 9.99m
                                },
                                new
                                {
                                    PlanoId = new Guid("4bf62345-0101-4dd0-9297-4eb541aa06cf"),
                                    Valor = 19.99m
                                });
                        });
